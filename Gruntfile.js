// Generated on 2015-02-03 using generator-fng 0.2.3
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    wiredep: {
      target: {
        ...
        exclude: [/bootstrap-sass-official/, /bootstrap.js/, '/json3/', '/es5-shim/', /blueimp-file-upload\/js\/jquery.fileupload-ui.js/, /blueimp-file-upload\/js\/jquery.fileupload-jquery-ui.js/
        ...
        files: [
          {
            ...
            cwd: '<%= yeoman.client %>',
            dest: '<%= yeoman.dist %>/public',
            src: ['*.{ico,png,txt}', '.htaccess', 'bower_components/**/*',  'assets/**/*', 'app/**/*', 'lib/*', 'index.html','NWIndex.html', 'components/**/*', 'bmp/*', 'svg/*', 'vid/*','sound/*','!**/examples/**', '!**/test/**','!**/docs/**','!**/doc/**', '!{app,components}/**/*.spec.js']
          }, {
            expand: true,
            cwd: '.tmp/images',
            dest: '<%= yeoman.dist %>/public/assets/images',
    ...
    injector: {
      ...
      scripts: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            ['{.tmp,<%= yeoman.client %>}/{app,components}/**/*.js', '!{.tmp,<%= yeoman.client %>}/app/app.js', '!{.tmp,<%= yeoman.client %>}/{app,components}/**/*.spec.js', '!{.tmp,<%= yeoman.client %>}/{app,components}/**/*.mock.js']
          ]
        }
      },
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': ['<%= yeoman.client %>/{app,components}/**/*.css','<%= yeoman.client %>/bower_components/bootstrap/dist/css/bootstrap.css']
        }
      }
    },
  });
  ...
  grunt.registerTask('serve', function(target) {
    ...
    grunt.task.run(['clean:server', 'env:all', 'concurrent:server', 'injector', 'wiredep', 'autoprefixer', 'express:dev', 'wait', 'open', 'watch']);
  });
